...
protected:
	...
	std::unique_ptr<ModeValue>clickModeValue = std::make_unique<ModeValue>("Mode", "Click Mode.", std::vector<int>{ BOTH, LEFTONLY, RIGHTONLY }, std::vector<std::string>{ "Both", "Left Only", "Right Only" }, BOTH);
