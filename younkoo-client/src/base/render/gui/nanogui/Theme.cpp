...
#include "OpenGL.h"
#include "Entypo.h"
#include "../../resources/fonts/entypo.h"
...
Theme::Theme(NVGcontext* ctx) {
	...
	mFontNormal = nvgCreateFontMem(ctx, "sans", harmony_sc_regular,
		harmony_sc_regular_size, 0);
	mFontBold = nvgCreateFontMem(ctx, "sans-bold", harmony_sc_bold,
		harmony_sc_bold_size, 0);
	mFontIcons = nvgCreateFontMem(ctx, "icons", entypo,
		entypo_size, 0);
